        ...
        <section class="modal-content">
            ...
            <article class="modal-body">
                <ul class="list-unstyled">
                    <li><b>Nome: </b> <?= ($publicity->name ?? "") ?>;</li>
                    <li><b>Abreviação: </b> <?= ($publicity->abbreviation ?? "") ?>;</li>
            ...
            <footer class="modal-footer">
                <a class="btn btn-danger pull-left" href="<?= url("sector/remove/{$publicity->id}") ?>"> <i class="fa fa-trash"></i> Excluir</a>
