<section class="modal fade" id="modal_remove_<?= md5($sector->id) ?>" tabindex="-1" role="dialog">
        ...
        <section class="modal-content">
            ...
            <article class="modal-body">
                <ul class="list-unstyled">
                    <li><b>Nome: </b> <?= ($sector->name ?? "") ?>;</li>
                    <li><b>Abreviação: </b> <?= ($sector->abbreviation ?? "") ?>;</li>
            ...
            <footer class="modal-footer">
                <a class="btn btn-danger pull-left" href="<?= url("sector/remove/{$sector->id}") ?>"> <i class="fa fa-trash"></i> Excluir</a>
