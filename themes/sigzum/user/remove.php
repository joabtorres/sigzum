<section class="modal fade" id="modal_remove_<?= md5($user->id) ?>" tabindex="-1" role="dialog">
    <article class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <section class="modal-content">
            ...
            <footer class="modal-footer">
                <a class="btn btn-danger pull-left" href="<?= url("user/remove/{$user->id}") ?>"> <i class="fa fa-trash"></i> Excluir</a>
